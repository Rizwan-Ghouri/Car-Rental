    ...
    <div className='dark:bg-black dark:text-white py-14 sm:pb-24'>
        <div className="container">
            ...
            <div className='space-y-4 pb-12'>
                ...
                <p data-aos="fade-up" className='text-center sm:px-44 md:px-50'>Lorem ipsum dolor sit amet consectetur adipisicing elit.{" "}</p>
            </div>
                  ...
                  return(
                    ...
                    >
                      <div className="grid place-items-center">
                        <img src="https://loremflickr.com/200/200/testimonials" alt="Testimonial images" className="h-20 w-20 rounded-full"/>
